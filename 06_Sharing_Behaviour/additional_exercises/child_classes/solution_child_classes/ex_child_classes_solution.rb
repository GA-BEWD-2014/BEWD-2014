...
require 'lib/cat_solution'
require 'lib/tiger_solution'

my_animal = Cat.new("Killer", "Siegfried")
my_big_animal = Tiger.new("Fluffy","Roy")


puts my_animal.get_info
puts my_animal.get_diet

puts my_big_animal.get_info
puts my_big_animal.get_diet