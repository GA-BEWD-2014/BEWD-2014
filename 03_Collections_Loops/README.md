...
| ------------- |:-------------|:-------------------|:-------------------|
| 20 min | Review|[coa_instr_ more_about_methods.rb](exercises/coa_instr_more_about_methods.rb)| In an effort to save time, review method syntax while introducing more on methods | 
...
| 50 min | Arrays|[coa_intr_array.rb](exercises/coa_intr_array.rb) <br> [ex_arrays.rb](exercises/ex_arrays.rb)| |
| 25 min | Hases | [coa_instr_collections_management.rb](exercises/coa_instr_collections_management.rb)| Focus on understanding the logic behind hashes. Less on syntax|
