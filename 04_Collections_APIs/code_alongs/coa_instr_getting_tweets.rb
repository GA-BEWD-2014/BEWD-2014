...
# => We are using twitter in this example but you can use another API.
# => Build this file from scratch with the students. When testing in NYC we found it helpful
# to work in irb and show how the data is returned from Twitter, before running this code in the terminal.
